...
const {httpOnResponse, httpOnModify} = require("./net-log");
const views = require("./views");

exports.main = function(t) {
    // Settings logger
    require("./console-logger").ConsoleLogger(preferences.get('extensions.mephisto.logLevel'));
    ...
    // Network Observer
    observer.add('http-on-examine-response', httpOnResponse);
    observer.add('http-on-examine-cached-response', httpOnResponse);
    observer.add('http-on-modify-request', httpOnModify);
